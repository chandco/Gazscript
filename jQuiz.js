...
/* sharing */
// count the seciotns, put a number for each of them using each and fill in the scores

$("#quiz-wrapper section.question").each(function(index, element) {
    $("<h3>Question " + (index+1) + " of " + totalScore + "</h3>").insertBefore($(this).find("h2:first-child"));
});
